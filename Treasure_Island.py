...
/______/______/______/______/______/______/______/______/______/______/[Nerort]
*******************************************************************************
''')
...
if first_choice == 'left':
    ...
    if second_choice == 'wait':
        third_choice = input('You arrived at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which colour dou you choose? ').lower()
        if third_choice == 'red':
